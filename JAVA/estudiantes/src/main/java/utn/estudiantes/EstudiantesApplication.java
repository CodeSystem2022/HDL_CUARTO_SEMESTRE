...
public class EstudiantesApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		logger.info(nl + "Ejecutando el metodo run de String..." + nl);
		var salir = false;
	...
	private boolean ejecutarOpciones(Scanner consola) {
		...
		switch (opcion) {
			...
			case 3 -> { // Agregar Estudiante
				...
				// Crear el objeto estudainte sin el id
			...
			case 4 -> {// Modificar estudiante
				logger.info("Modificara estudiante: " + nl);
				logger.info("Ingrese el id estudiante: ");
				var idestudiantes = Integer.parseInt(consola.nextLine());
				// Buscamos el estudiante a modificar
				Estudiantes estudiante = estudianteServicio.buscarEstudiantePorId(idestudiantes);
				if (estudiante != null) {
					logger.info("Nombre: ");
					var nombre = consola.nextLine();
					logger.info("Apellido: ");
					...
					logger.info("Estudiante No encontrado con el id: " + idestudiantes + nl);
			...
			case 5 -> {// Eliminar estudiante
				...
				var estudiante = estudianteServicio.buscarEstudiantePorId(idEstudiantes);
				if (estudiante != null) {
